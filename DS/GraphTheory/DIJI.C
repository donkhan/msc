...
void internal_test2(){
	...
	VERTEX_NAMING_STARTS_WITH = 'a';
	edges[0].source = 'a';edges[0].destination = 'b'; edges[0].cost = 3;
	edges[1].source = 'a';edges[1].destination = 'd'; edges[1].cost = 2;
	edges[2].source = 'a';edges[2].destination = 'g'; edges[2].cost = 6;

	edges[3].source = 'b';edges[3].destination = 'c'; edges[3].cost = 6;
	edges[4].source = 'b';edges[4].destination = 'e'; edges[4].cost = 1;

	edges[5].source = 'c';edges[5].destination = 'f'; edges[5].cost = 1;

	edges[6].source = 'd';edges[6].destination = 'b'; edges[6].cost = 2;
	edges[7].source = 'd';edges[7].destination = 'e'; edges[7].cost = 3;

	edges[8].source = 'e';edges[8].destination = 'f'; edges[8].cost = 4;
	edges[9].source = 'g';edges[9].destination = 'f'; edges[9].cost = 2;
